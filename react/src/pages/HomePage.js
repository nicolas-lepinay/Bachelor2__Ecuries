...
import Item1 from '../assets/img/animation-items/item1.png';
import Item1Webp from '../assets/img/animation-items/item1.webp';
					...
					<div className={classNames('row', 'h-fluid-min-100', classes.intro)}>
						...
						<div
							...
							<div>
								...
								<p className='h2 mb-5'>
									Prenez un café et {' '}
									<span className='text-info'>détendez-vous.</span>
								</p>
								<Button
									color='primary'
									size='lg'
